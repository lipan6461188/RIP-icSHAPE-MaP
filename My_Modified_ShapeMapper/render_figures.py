...
def render_profiles(num, seq, reactivity, stderr,
    ...
    if mrstyle == 'line':
        ...
        ax3.step(num, rx_rates, zorder=3, color=rx_color, linewidth=1.5)
        ax3.step(num, bg_rates, zorder=2, color=bg_color, linewidth=1.5)
        ax3.step(num, dc_rates, zorder=2, color=dc_color, linewidth=1.5)
...
if __name__=="__main__":
    ...
    h = "Profile plot style: line plot or step plot"
    parser.add_argument("--mrstyle", help=h, type=str, default='line')
    ...
    if p.plot is not None and (d["Modified_rate"] is None or 
        ...
        render_profiles(
            ...
            p.plot, title, qc_pass, p.mrstyle)
